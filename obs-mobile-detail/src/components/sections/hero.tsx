  ...
  return (
    <section className="relative overflow-hidden border-b border-white/8 bg-[#0b0d10]">
      <Image
        ...
        fill
        priority
        className="scale-[1.08] object-cover object-[72%_center] opacity-56 transition-transform duration-1000"
      />
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(7,9,11,0.98)_0%,rgba(7,9,11,0.92)_34%,rgba(7,9,11,0.52)_62%,rgba(7,9,11,0.16)_100%)]" />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(9,11,14,0.2)_0%,rgba(9,11,14,0.0)_28%,rgba(9,11,14,0.28)_62%,rgba(9,11,14,0.82)_100%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_22%_28%,rgba(142,164,189,0.15),transparent_28%),radial-gradient(circle_at_34%_42%,rgba(184,98,47,0.16),transparent_22%),radial-gradient(circle_at_88%_18%,rgba(82,103,128,0.18),transparent_20%)]" />
      <div className="absolute inset-x-0 top-0 h-28 bg-gradient-to-b from-white/[0.045] to-transparent" />
      <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-[#0b0d10] via-[#0b0d10]/84 to-transparent" />
